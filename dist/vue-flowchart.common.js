...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleFlowchart_vue_vue_type_style_index_0_id_217149ce_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("d959");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleFlowchart_vue_vue_type_style_index_0_id_217149ce_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleFlowchart_vue_vue_type_style_index_0_id_217149ce_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_mini_css_extract_plugin_dist_loader_js_ref_8_oneOf_1_0_node_modules_css_loader_index_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_lib_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_lib_loader_js_ref_8_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SimpleFlowchart_vue_vue_type_style_index_0_id_217149ce_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./src/components/SimpleFlowchart.vue?vue&type=template&id=217149ce&scoped=true&
...
var FlowchartNodevue_type_template_id_7c23725f_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/FlowchartNode.vue?vue&type=template&id=7c23725f&
...
/* harmony default export */ var FlowchartNodevue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      ...
      availableVersions: [],
      selectedVersion: "" // nodeCategory: ["Rule", "Action", "Script", "Decision", "Fork", "Join"]
  ...
  methods: {
    jumpMethod: function jumpMethod(id) {
      this.$emit("jumpMethod", id);
    },
    getAvailableVersions: function getAvailableVersions() {
      var allVersions = this.versions.map(function (version) {
        var versionLabel = version.id.slice(version.id.indexOf(":") + 1, version.id.length);
        return {
          value: version.id,
          label: versionLabel
        };
      ...
      this.availableVersions = result.concat(_toConsumableArray(allVersions));
    },
...
var FlowchartNode_component = normalizeComponent(
  ...
  FlowchartNodevue_type_template_id_7c23725f_render,
  FlowchartNodevue_type_template_id_7c23725f_staticRenderFns,
  false,
  null,
  null,
  null
  ...
  methods: {
    getLinks: function getLinks() {
      ...
      var lines = this.scene.links.map(function (link) {
        var fromNode = _this2.findNodeWithID(link.from);

        var toNode = _this2.findNodeWithID(link.to);
        ...
        if (!fromNode || !toNode) {
          ...
          _this2.$emit("addErrors", error);

          return null;
        }

        x = _this2.scene.centerX + fromNode.x;
        y = _this2.scene.centerY + fromNode.y;
        posResult = _this2.getPortPosition(fromNode, "right", x, y, link.button, link.quickReply !== -1 && link.quickReply !== undefined && link.quickReply !== null ? "quickReply" : "button");
        ...
        cx = _posResult2[0];
        cy = _posResult2[1];
        x = _this2.scene.centerX + toNode.x;
        y = _this2.scene.centerY + toNode.y;
        posResult = _this2.getPortPosition(toNode, "left", x, y);
        ...
        if (_this2.updateLine.toNodeId === link.to) {
          if (_this2.updateLine.buttonHeight) {
            ey += _this2.updateLine.buttonHeight / 2;
          }

          var element = document.getElementById("button_" + toNode.id + "_" + (_this2.updateLine.buttonsLength - 1));

          if (_this2.updateLine.buttonHeight >= 0 && element || _this2.updateLine.buttonHeight < 0 && !element) {
            _this2.updateLine = _objectSpread({}, _this2.updateLine, {
              buttonHeight: null,
              buttonsLength: null
            });
          }
    ...
    getPortPosition: function getPortPosition(node, type, x, y, buttonId, styleType) {
      ...
      if (type === "right") {
        ...
        if (buttonId != null && buttonId !== -1 && !this.scene.nodes[index].isLocked) {
          ...
          if (buttonId === -1 && this.draggingLink && this.draggingLink.buttonIndex !== undefined && !this.scene.nodes[index].isLocked) {
    ...
    linkingStop: function linkingStop(index) {
      ...
      if (this.draggingLink && this.draggingLink.from !== index) {
        ...
        var existed = this.scene.links.find(function (link) {
          return link.from === _this4.draggingLink.from && (link.button ? link.button === _this4.findNodeWithID(link.from).buttons[_this4.draggingLink.buttonIndex].id : true);
        });
...
// EXTERNAL MODULE: ./src/components/SimpleFlowchart.vue?vue&type=style&index=0&id=217149ce&scoped=true&lang=scss&
var SimpleFlowchartvue_type_style_index_0_id_217149ce_scoped_true_lang_scss_ = __webpack_require__("69f4");
